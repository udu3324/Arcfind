...
public class JarContents {
    //gets the files in a jar and gets the contents of them
    public static ArrayList<String> get(File sevenZip) {
        System.out.println("JarContents Status: Currently Extracting " + sevenZip);
        ...
        System.out.println("JarContents Status: Done Extracting " + sevenZip);
